...
class CategoriesController extends AbstractController
{
    ...
    #[Route('/{id}/afficher', name: 'app_categories_showadmin', methods: ['GET'])]
    public function showadmin(Categories $category): Response
    {
        return $this->render('categories/showadmin.html.twig', [
            'category' => $category,
        ]);
    }
